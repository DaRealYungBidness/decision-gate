...
- Configs predefinides: `configs/presets/` (vegeu [`Docs/guides/preset_configs.md`](Docs/guides/preset_configs.md))
- Desplegament en contenidors: [`Docs/guides/container_deployment.md`](Docs/guides/container_deployment.md)
- Estat d'execució persistent: configureu `run_state_store` a `decision-gate.toml` per usar
  el backend SQLite (vegeu [`Docs/configuration/decision-gate.toml.md`](Docs/configuration/decision-gate.toml.md)).

## Documentació

- Introducció: [`Docs/guides/getting_started.md`](Docs/guides/getting_started.md)
- Configs predefinides: [`Docs/guides/preset_configs.md`](Docs/guides/preset_configs.md)
- Desplegament en contenidors: [`Docs/guides/container_deployment.md`](Docs/guides/container_deployment.md)
- Configuració: [`Docs/configuration/decision-gate.toml.md`](Docs/configuration/decision-gate.toml.md)
- Desenvolupament de proveïdors: [`Docs/guides/provider_development.md`](Docs/guides/provider_development.md)
- Guia de seguretat: [`Docs/guides/security_guide.md`](Docs/guides/security_guide.md)
- Patrons d'integració: [`Docs/guides/integration_patterns.md`](Docs/guides/integration_patterns.md)
- Manual d'evidència JSON: [`Docs/guides/json_evidence_playbook.md`](Docs/guides/json_evidence_playbook.md)
- Manual LLM-native: [`Docs/guides/llm_native_playbook.md`](Docs/guides/llm_native_playbook.md)
- Dogfood de la porta de release en CI: [`Docs/guides/ci_release_gate_dogfood.md`](Docs/guides/ci_release_gate_dogfood.md)
...
- Arquitectura:
  - [`Docs/architecture/comparator_validation_architecture.md`](Docs/architecture/comparator_validation_architecture.md)
  - [`Docs/architecture/decision_gate_assetcore_integration_contract.md`](Docs/architecture/decision_gate_assetcore_integration_contract.md)
  - [`Docs/architecture/decision_gate_namespace_registry_rbac_architecture.md`](Docs/architecture/decision_gate_namespace_registry_rbac_architecture.md)
  - [`Docs/architecture/decision_gate_auth_disclosure_architecture.md`](Docs/architecture/decision_gate_auth_disclosure_architecture.md)
  - [`Docs/architecture/decision_gate_evidence_trust_anchor_architecture.md`](Docs/architecture/decision_gate_evidence_trust_anchor_architecture.md)
  - [`Docs/architecture/decision_gate_runpack_architecture.md`](Docs/architecture/decision_gate_runpack_architecture.md)
  - [`Docs/architecture/decision_gate_scenario_state_architecture.md`](Docs/architecture/decision_gate_scenario_state_architecture.md)
  - [`Docs/architecture/decision_gate_provider_capability_architecture.md`](Docs/architecture/decision_gate_provider_capability_architecture.md)
  - [`Docs/architecture/decision_gate_system_test_architecture.md`](Docs/architecture/decision_gate_system_test_architecture.md)
...
[`Docs/guides/ci_release_gate_dogfood.md`](Docs/guides/ci_release_gate_dogfood.md).
...
codi). El hub d'integració canònic és a [`Docs/integrations/assetcore/`](Docs/integrations/assetcore/).
...
[`Docs/generated/decision-gate`](Docs/generated/decision-gate). Després de qualsevol canvi de comportament o esquema,
...
- [`Docs/generated/decision-gate/tooling.json`](Docs/generated/decision-gate/tooling.json): esquemes d'eines MCP
- [`Docs/generated/decision-gate/providers.json`](Docs/generated/decision-gate/providers.json): esquemes de comprovació de proveïdors
- [`Docs/generated/decision-gate/schemas/`](Docs/generated/decision-gate/schemas/): esquemes JSON d'escenaris + configuració
- [`Docs/generated/decision-gate/examples/`](Docs/generated/decision-gate/examples/): exemples canònics
...
Vegeu [`Docs/security/threat_model.md`](Docs/security/threat_model.md) i [`Docs/guides/security_guide.md`](Docs/guides/security_guide.md) per al
...
discussió. Vegeu [`CONTRIBUTING.md`](CONTRIBUTING.md) per a més detalls.
