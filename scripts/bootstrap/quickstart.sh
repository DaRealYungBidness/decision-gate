...
# =============================================================================
# Module: Decision Gate Quickstart Smoke
# Description: Start a local MCP server and run a quick scenario flow.
# Purpose: Provide a one-command smoke test for the CLI/MCP pipeline.
# Dependencies: bash, curl, cargo (or decision-gate binary)
# =============================================================================
set -euo pipefail
