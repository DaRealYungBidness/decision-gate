...
pub const AUTHORING_FORMATS: &str = include_str!("../../Docs/generated/decision-gate/authoring.md");
...
pub const PROVIDERS_SUMMARY: &str = include_str!("../../Docs/generated/decision-gate/providers.md");
