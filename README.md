...
- Preset configs: `configs/presets/` (see [`Docs/guides/preset_configs.md`](Docs/guides/preset_configs.md))
- Container deployment: [`Docs/guides/container_deployment.md`](Docs/guides/container_deployment.md)
- Durable run state: configure `run_state_store` in `decision-gate.toml` to use
  the SQLite backend (see [`Docs/configuration/decision-gate.toml.md`](Docs/configuration/decision-gate.toml.md)).

## Docs

- Getting started: [`Docs/guides/getting_started.md`](Docs/guides/getting_started.md)
- Preset configs: [`Docs/guides/preset_configs.md`](Docs/guides/preset_configs.md)
- Container deployment: [`Docs/guides/container_deployment.md`](Docs/guides/container_deployment.md)
- Configuration: [`Docs/configuration/decision-gate.toml.md`](Docs/configuration/decision-gate.toml.md)
- Provider development: [`Docs/guides/provider_development.md`](Docs/guides/provider_development.md)
- Security guide: [`Docs/guides/security_guide.md`](Docs/guides/security_guide.md)
- Integration patterns: [`Docs/guides/integration_patterns.md`](Docs/guides/integration_patterns.md)
- JSON evidence playbook: [`Docs/guides/json_evidence_playbook.md`](Docs/guides/json_evidence_playbook.md)
- LLM-native playbook: [`Docs/guides/llm_native_playbook.md`](Docs/guides/llm_native_playbook.md)
- CI release gate dogfood: [`Docs/guides/ci_release_gate_dogfood.md`](Docs/guides/ci_release_gate_dogfood.md)
...
integration hub lives at [`Docs/integrations/assetcore/`](Docs/integrations/assetcore/).
...
[`Docs/generated/decision-gate`](Docs/generated/decision-gate). After any behavior or schema change, update the
...
- [`Docs/generated/decision-gate/tooling.json`](Docs/generated/decision-gate/tooling.json): MCP tool schemas
- [`Docs/generated/decision-gate/providers.json`](Docs/generated/decision-gate/providers.json): provider check schemas
- [`Docs/generated/decision-gate/schemas/`](Docs/generated/decision-gate/schemas/): scenario + config JSON schemas
- [`Docs/generated/decision-gate/examples/`](Docs/generated/decision-gate/examples/): canonical examples
...
evidence. See [`Docs/security/threat_model.md`](Docs/security/threat_model.md) and
[`Docs/guides/security_guide.md`](Docs/guides/security_guide.md) for the threat model and operational controls.
...
discussion. See [`CONTRIBUTING.md`](CONTRIBUTING.md) for details.
