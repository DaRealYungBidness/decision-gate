...
def main() -> int:
    ...
    spec = load_env_json("DG_SCENARIO_SPEC") or default_time_after_spec("example-basic", 0)
    scenario_id = spec["scenario_id"]
    run_config = load_env_json("DG_RUN_CONFIG") or default_run_config(scenario_id, "run-basic-1")
