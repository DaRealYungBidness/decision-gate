...
3. **OSS vs Enterprise Boundary (Authoritative)**:
   ...
   - No enterprise deps in OSS crates; enterprise code lives in the private enterprise repository;
...
- Enterprise-only system tests in the private enterprise repository.
