...
[F:crates/decision-gate-core/src/core/spec.rs L51-L114](crates/decision-gate-core/src/core/spec.rs#L51-L114) [F:crates/decision-gate-mcp/src/tools.rs L721-L895](crates/decision-gate-mcp/src/tools.rs#L721-L895) [F:crates/decision-gate-core/src/core/state.rs L357-L394](crates/decision-gate-core/src/core/state.rs#L357-L394)
...
[F:crates/decision-gate-core/src/core/spec.rs L51-L114](crates/decision-gate-core/src/core/spec.rs#L51-L114)

Stage-level behavior is defined by `StageSpec` (entry packets, gates, branching,
optional timeout).
[F:crates/decision-gate-core/src/core/spec.rs L121-L140](crates/decision-gate-core/src/core/spec.rs#L121-L140)
...
[F:crates/decision-gate-mcp/src/tools.rs L721-L749](crates/decision-gate-mcp/src/tools.rs#L721-L749) [F:crates/decision-gate-mcp/src/tools.rs L2045-L2066](crates/decision-gate-mcp/src/tools.rs#L2045-L2066)

### Start Run
`scenario_start` creates a new run state using the control plane and persists it
via the configured store.
[F:crates/decision-gate-mcp/src/tools.rs L760-L814](crates/decision-gate-mcp/src/tools.rs#L760-L814)
...
[F:crates/decision-gate-mcp/src/tools.rs L2144-L2257](crates/decision-gate-mcp/src/tools.rs#L2144-L2257) [F:crates/decision-gate-core/src/core/state.rs L357-L394](crates/decision-gate-core/src/core/state.rs#L357-L394)
...
[F:crates/decision-gate-core/src/core/state.rs L357-L394](crates/decision-gate-core/src/core/state.rs#L357-L394)

Run lifecycle status is a closed enum: `active`, `completed`, `failed`.
[F:crates/decision-gate-core/src/core/state.rs L72-L85](crates/decision-gate-core/src/core/state.rs#L72-L85)
...
[F:crates/decision-gate-core/src/runtime/engine.rs L153-L178](crates/decision-gate-core/src/runtime/engine.rs#L153-L178) [F:crates/decision-gate-mcp/src/tools.rs L2029-L2066](crates/decision-gate-mcp/src/tools.rs#L2029-L2066)
...
[F:crates/decision-gate-core/src/runtime/store.rs L53-L127](crates/decision-gate-core/src/runtime/store.rs#L53-L127)
...
[F:crates/decision-gate-config/src/config.rs L1523-L1582](crates/decision-gate-config/src/config.rs#L1523-L1582)
...
| MCP tool lifecycle | `crates/decision-gate-mcp/src/tools.rs` | scenario_define/start/next/submit/trigger/status. |
